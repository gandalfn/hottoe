...
namespace Gst {
	namespace Audio {
		[CCode (cname = "GST_AUDIO_CAPS_MAKE")]
		public static unowned string caps_make(string format);
		...
		public abstract class Filter : Gst.Base.Transform {
			...
			public uint channels {
				[CCode (cname = "GST_AUDIO_FILTER_CHANNELS")]
				get;
			}
			public int bps {
		...
		public class Info {
			...
			public Gst.Audio.Format format {
				[CCode (cname = "GST_AUDIO_INFO_FORMAT")]
				get;
			}
		}
		[CCode (cheader_filename = "gst/audio/audio.h", has_type_id = false)]
