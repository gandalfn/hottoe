...
namespace PulseAudio {
        ...
        [Compact]
        [CCode (cname="pa_proplist", cprefix="pa_proplist_", copy_function="pa_proplist_copy", free_function="pa_proplist_free", has_type_id=false)]
        ...
        public class Context {
                ...
                public delegate void SuccessCb(Context c, bool success);
                ...
                public delegate void SinkInfoCb(Context c, SinkInfo? i, bool eol);
                [CCode (cname = "pa_source_info_cb_t")]
                public delegate void SourceInfoCb(Context c, SourceInfo? i, bool eol);
                [CCode (cname = "pa_card_info_cb_t")]
                public delegate void CardInfoCb(Context c, CardInfo? i, bool eol);
                [CCode (cname = "pa_sink_input_info_cb_t")]
                public delegate void SinkInputInfoCb(Context c, SinkInputInfo? i, bool eol);
                [CCode (cname = "pa_source_output_info_cb_t")]
                public delegate void SourceOutputInfoCb(Context c, SourceOutputInfo? i, bool eol);
                ...
                public delegate void ModuleInfoCb(Context c, ModuleInfo? i, bool eol);
                [CCode (cname = "pa_client_info_cb_t")]
                public delegate void ClientInfoCb(Context c, ClientInfo? i, bool eol);
                [CCode (cname = "pa_sample_info_cb_t")]
                public delegate void SampleInfoCb(Context c, SampleInfo? i, bool eol);
        ...
        public class Stream {
                ...
                [Flags, CCode (cname="pa_stream_flags_t", cprefix="PA_STREAM_", has_type_id=false)]
                public enum Flags {
                        START_CORKED,
                        INTERPOLATE_TIMING,
                        NOT_MONOTONIC,
        ...
        [CCode (cname="pa_sink_info", has_type_id=false, has_copy_function=false, has_destroy_function=false)]
        public struct SinkInfo {
                ...
                [CCode (cname = "ports", array_null_terminated = true)]
                public (unowned SinkPortInfo?)[] ports;
                public unowned SinkPortInfo? active_port;
        }
        ...
        public struct SourceInfo {
                ...
                public uint32 n_ports;
                [CCode (cname = "ports", array_null_terminated = true)]
                public (unowned SourcePortInfo?)[] ports;
                public unowned SourcePortInfo? active_port;
        }
        ...
        [CCode (cname="pa_card_profile_info2", has_type_id=false, has_copy_function=false, has_destroy_function=false)]
        ...
        [CCode (cname="pa_card_port_info", has_type_id=false, has_copy_function=false, has_destroy_function=false)]
        public struct CardPortInfo {
                public string name;
                public string description;
                public uint32 priority;
                public PortAvailable available;
                public Direction direction;
                [CCode (cname = "profiles2", array_null_terminated = true)]
                public (unowned CardProfileInfo?)[] profiles;
                public Proplist proplist;
                public int64 latency_offset;
        }

        [CCode (cname="pa_card_info", has_type_id=false, has_copy_function=false, has_destroy_function=false)]
        public struct CardInfo {
                ...
                [CCode (cname = "profiles2", array_null_terminated = true)]
                public unowned (unowned CardProfileInfo?)[] profiles;
                [CCode (cname = "active_profile2")]
                public unowned CardProfileInfo? active_profile;
                [CCode (cname = "ports", array_null_terminated = true)]
                public (unowned CardPortInfo?)[] ports;
                public Proplist proplist;
        }
