...
namespace Gst {
	...
	[CCode (cheader_filename = "gst/gst.h", lvalue_access = false, has_type_id = false)]
	...
	[CCode (cheader_filename = "gst/gst.h", cname = "GST_READ_UINT24_BE")]
	public static int32 read_uint24_be (uint8* val);
	[CCode (cheader_filename = "gst/gst.h", cname = "GST_READ_UINT24_LE")]
	public static int32 read_uint24_le (uint8* val);
}
